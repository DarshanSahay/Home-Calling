	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				#ifdef _SNOW_ON
				float staticSwitch927 = ( saturate( WorldSpaceNormal.y ) * SnowLeavesFloat );
				#else
				...
				float3 temp_output_937_0 = float3( (WindDirection).xz ,  0.0 );
				float2 panner942 = ( 1.0 * _Time.y * ( temp_output_937_0 * WindSpeedFloat * 10.0 ).xy + (WorldSpacePosition).xy);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv0954 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_937_0 = float3( (WindDirection).xz ,  0.0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv0954 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_937_0 = float3( (WindDirection).xz ,  0.0 );
...
/*ASEBEGIN
Version=17009
847;197;1924;1015;-312.003;-207.6572;2.199072;True;False
...
Node;AmplifyShaderEditor.SamplerNode;948;2364.949,1515.544;Inherit;True;Global;NoiseTextureFloat;NoiseTextureFloat;3;0;Create;False;0;0;False;0;None;e5055e0d246bd1047bdb28057a93753c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;951;1858.261,833.4222;Inherit;True;Property;_TextureSample2;Texture Sample 0;3;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Instance;948;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;953;1889.522,1220.808;Float;False;Property;_WiggleStrenght;Wiggle Strenght;9;0;Create;False;0;0;False;0;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;927;3714.475,546.4106;Inherit;False;Property;_Snow;Snow;3;0;Create;False;0;0;False;0;1;1;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;931;4056.012,1600.871;Inherit;False;Property;_Snow3;Snow;8;0;Create;True;0;0;False;0;1;1;0;True;_SNOW_ON;Toggle;2;Key0;Key1;Reference;927;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;916;4740.732,1060.633;Float;False;True;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;3;IL3DN/Leaf;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;0;Forward;11;False;False;False;True;2;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;11;Workflow;1;Surface;0;  Blend;0;Two Sided;0;Cast Shadows;1;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;Meta Pass;1;Vertex Position,InvertActionOnDeselection;1;0;5;True;True;True;True;True;False;0
...
ASEEND*/
//CHKSM=233BC73A54DC1C80B0F9703A25284BDAFFC9DED6